...
>
> **Update (2026-05-27):** Card A's current published artifact is **load-blocked on bleeding-edge vLLM** without the upstream fixes catalogued at [`vllm-project/vllm#43564`](https://github.com/vllm-project/vllm/issues/43564) — now substantially actionable: [`#43722`](https://github.com/vllm-project/vllm/pull/43722) + [`#43723`](https://github.com/vllm-project/vllm/pull/43723) + [`#41834`](https://github.com/vllm-project/vllm/pull/41834) configs + jasl/vllm@27fd665b scheduler patch. Until those land, **production deployments should pin `jasl/vllm@428e08e` or `jasl/vllm@ds4-sm120-experimental@abad5dc71`** for the verified numbers above. For consumer Blackwell RTX PRO 6000 deployments that need MTP, the [W4A16-FP8-MTP sibling](https://github.com/canada-quant/dsv4-flash-w4a16-fp8-mtp) was verified 2026-05-27 at **24/30 AIME-30 c=4 thinking with 0 CUDA errors and 91.6% MTP acceptance** on jasl@27fd665b — that's the canonical RTX PRO 6000 MTP path today. **1M-context (in the status line above) is dual-DGX-Spark-only** — H200 and RTX PRO 6000 deployments serve at `--max-model-len 4096` / `16384` respectively per the recipe scripts.
